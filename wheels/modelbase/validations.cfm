...
<cffunction name="$getValidations">
	<cfreturn variables.wheels.class.validations>
</cffunction>

<cffunction name="$clearValidations">
	<cfset StructClear(variables.wheels.class.validations)>
</cffunction>